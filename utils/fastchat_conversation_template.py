...
register_conv_template(
    Conversation(
        name="vicuna_v1.1_math",
        system="A chat between a curious user and an artificial intelligence assistant. "
        "The assistant gives helpful, detailed, and polite answers to the given math questions. "
        "Make sure to carefully read and understand each question before providing the final answer. Use the format #### [value] to conclude the final answer. ",
        roles=("USER", "ASSISTANT"),
        messages=(),
        offset=0,
        sep_style=SeparatorStyle.ADD_COLON_TWO,
